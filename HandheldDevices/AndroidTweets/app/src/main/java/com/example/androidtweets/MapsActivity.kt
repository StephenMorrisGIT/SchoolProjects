...
import edu.gwu.androidtweets.TweetsActivity
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun updateConfirmButton(address: Address) {
        val greenColor = ContextCompat.getColor(this, R.color.buttonGreen)
        val checkIcon = ContextCompat.getDrawable(this, R.drawable.ic_baseline_check_24)
